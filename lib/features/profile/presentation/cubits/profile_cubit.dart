...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  //fetch user profile using repo for single use
  ...
  // return user profile given uid -> useful for many profiles for post
  ...
  Future<void> toggleFollow(String currentUserId, String targetUserId) async {
    try {
      ...
      emit(ProfileError("Error following/unfollowing: $e"));
    }
  }
}
